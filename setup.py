...
name, version, entry_points, and data_files because ament_python reads
setup.py while pip reads pyproject.toml.  Keep both in sync when
changing either.
"""
...
setup(
    name=package_name,
    version="0.1.0",
    packages=find_packages(include=["go2_audio*"]),
    entry_points={
        "console_scripts": [
